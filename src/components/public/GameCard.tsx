...
export function GameCard({ game }: { game: Game }) {
  ...
  return (
    <div className="glass game-card" style={{ padding: 16, display: "flex", gap: 14 }}>
      <span style={{ width: 50, height: 66, borderRadius: 7, background: "var(--glass)", border: "1px solid var(--glass-bd)", flex: "none",
      ...
      <div>
        ...
        <div style={{ color: "var(--muted)", fontSize: 13, marginTop: 2 }}>{game.platform}{game.genre ? ` · ${game.genre}` : ""}</div>
        <span style={{ display: "inline-block", marginTop: 10, fontSize: 10.5, textTransform: "uppercase", letterSpacing: ".06em",
